 ...
 * @date 2019/3/12 0:51
 */
@ApiModel(description = "or解析器")
public class OrResolver {

  private final static String OPERATOR = RuleEnum.OR.getOperator();
  ...
  /**
   * or核心算法：计算Boolean数组中存在真，则真；全部为假，则假
   * @param array
   * @return
   */
