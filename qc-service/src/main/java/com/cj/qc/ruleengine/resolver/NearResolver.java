 ...
 * @date 2019/3/12 0:26
 */
@ApiModel(description = "ne解析器")
public class NearResolver {

  private final static String OPERATOR = RuleEnum.NE.getOperator();
  private final static int RANGE = RuleType.NE_RANGE;
  ...
  /**
   * 判断是否“W1 ne W2”：要求“W1”在“W2”的附近，近似于“(W1 bf W2) or (W2 after W1)”
   * @param matchStr w1 ne w2
   * @param source 源字符串
   * @param range 间距
   * @return
   */
  ...
  public static BorderBuffer resolveObject(String leftMatchStr, String rightMatchStr, String source, int range){
    List<BorderLocationBuffer> borderLocationBuffers=RuleUtil.borderEvaluate(leftMatchStr, rightMatchStr, source, BorderEnum.NEAR, range);
