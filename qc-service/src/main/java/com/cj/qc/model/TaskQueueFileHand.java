...
/**
 * @author chenzhaowen
 * @description 手动质检任务队列文件类
 * @date 2019/3/21 14:05
 */
@AllArgsConstructor
@NoArgsConstructor
@Data
@ApiModel(description = "手动质检任务队列文件类")
@Table ( name ="cj_qc_task_queue_file_hand" )
public class TaskQueueFileHand {

	@ApiModelProperty("手动质检任务队列文件ID")
	@Id
	@Column(name = "id",columnDefinition="bigint(20) COMMENT '手动质检任务队列文件ID'")
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Long id;

	@ApiModelProperty("手动质检任务ID")
	@Column(name = "task_id", columnDefinition = "bigint(20) COMMENT '手动质检任务ID'" )
	private Long taskId;
