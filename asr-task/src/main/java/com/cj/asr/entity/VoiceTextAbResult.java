...
@Data
@Entity
@Table ( name ="cj_voice_text_ab_result" )
@EntityListeners(AuditingEntityListener.class)
public class VoiceTextAbResult  implements Serializable {


	private static final long serialVersionUID =  592618218942166634L;
	 ...
	 * 音频名称
	 */
   	@Column(name = "audio_name", columnDefinition = "音频名称" )
